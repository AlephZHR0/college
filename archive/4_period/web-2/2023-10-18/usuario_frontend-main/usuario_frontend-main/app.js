...
async function buscarTodosOsUsuarios() {
    ...
    usuarios.forEach(usuario => {
        ...
        novaLinha.insertCell(3).innerText = usuario.cpf;
        novaLinha.insertCell(4).innerText = usuario.telefone;
...
async function adicionarUsuario(evento) {
    ...
    const resposta = await fetch(`${url_base}/`, {
        ...
        body: JSON.stringify({ name: nome, email: email , cpf: cpf, telefone: telefone})
    });
